...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800" >Cash Deposit</h1>
       ...
       <div class="card-body" > 
        <div class="container">
        <form class="row g-3" action="Depval.php" method="POST">
                            ...
                            <div class="col-12">
                             ...
                             <div class="col-12">
                               <button class="btn btn-primary" type="submit" name="submit">DEPOSIT</button>
                             </div>
        ...
        <div class="col-6">
        <a class="btn btn-success" href="deposithistory.php">History</a>
        </div>
