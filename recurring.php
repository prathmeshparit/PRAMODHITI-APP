...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800" >Create a Recurring Account</h1>
       ...
       <div class="card-body" >        
        ...
        <div class="container">
        <form class="row g-3" action="Recval.php" method="POST">
        ...
        <div class="col-md-5">
          ...
          <input type="text" name="mon" class="form-control" maxlength="10" minlength="10" pattern="\d{10}" id="validationDefault02"  required>
        </div>
  ...
  <div class="col-md-5">
        ...
        <div class="col-md-5">
                ...
                <input type="number" name="depamt" class="form-control" id="validationDefault02"  required>
            </div>


            <div class="col-md-5">
                <label for="validationDefault02" class="form-label">Tenure(In Months)</label>
