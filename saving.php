...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800" >Create a Saving Account</h1>
       ...
       <div class="container " > 
                            ...
                            <form class="row g-3" action="Saval.php" method="POST">
                            ...
                            <div class="col-md-5">
                              ...
                              <textarea  name="address" class="form-control" id="validationDefault03" maxlength="150" required>
                              </textarea>
                            </div>
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="number" name="ai" class="form-control" id="validationDefault02"  >
                                </div>
