...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800" >Shares Account DataBase</h1>
</div>
    ...
    <table class="table table-bordered border-primary" id="datatable" width="100%" cellspacing="0">
            <thead>
              ...
              <tbody>
                ...
                <td> <?php  echo $row['samount']; ?></td>
                <!-- <td> <form action="updatesharesdata.php" method="POST">
                <input type="hidden" name="editacno" value="<?php  echo $row['saccountno']; ?>">
