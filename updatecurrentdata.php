...
?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800" >Edit Current Account</h1>
        </div>
       ...
       <?php
                ...
                if(isset($_POST['edit']))
                {
                    ...
                    $sql="SELECT * FROM `current` WHERE accountno='$acno'";
  ...
  <input type="text" name="fname"   class="form-control" id="validationDefault01"  required>
                        ...
                        <form class="row g-3" action="updatecurrentdataval.php" method="POST">
                    ...
                    <!-- <div class="col-md-5">
                      ...
                      <textarea  name="text" value="" class="form-control" id="validationDefault03" maxlength="150" required>
                      </textarea>
                    </div> -->
                    ...
                    <div class="col-6">
                      <a class="btn btn-danger"  href="currentdata.php" >CANCLE</a>
                    </div>
